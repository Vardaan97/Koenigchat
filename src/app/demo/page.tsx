...
// Demo page to test the chat widget
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={course.title} className="border rounded-xl overflow-hidden hover:shadow-lg transition">
                ...
                <div className="p-6">
                  <span className="text-xs font-medium text-primary">{course.vendor}</span>
      ...
      <footer className="py-8 px-4 bg-slate-900 text-slate-400 text-sm">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p>&copy; 2025 Koenig Solutions. All rights reserved.</p>
          <p>Microsoft Training Services Partner of the Year 2025</p>
        </div>
      </footer>
      ...
      <ChatWidget
        ...
        pageContext={{
          ...
          title: 'Koenig Solutions - IT Training Demo Page',
          type: 'home',
        }}
      />
    </div>
